...
public class InicioController implements Initializable {    
    ...
    private void irMiembro(ActionEvent event) throws IOException {
        texto.setText("");
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/apkgastos/Miembro.fxml"));
    ...
    private void irRegistrar(ActionEvent event) throws IOException{
        ...
        texto.setText("");
        FXMLLoader miCargador = new FXMLLoader(getClass().getResource("/apkgastos/REGISTRO.fxml"));
